...
async def check_concluded_proposals_task(bot: commands.Bot):
    ...
    try:
        ...
        for proposal_id, proposal_data in bot.ongoing_votes.items():
            ...
            logger.info(f"Yes vote count: {proposal_data['yes_count']} No vote count: {proposal_data['no_count']} Abstain vote count: {proposal_data['abstain_count']}")
        ...
        # Optionally save to ongoing_votes.json
