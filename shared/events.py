...
def setup_shared_events(bot: commands.Bot, contributors: List[Dict[str, str]], emoji_id_mapping: Dict[str, str], proposals: List[Dict[str, str]], new_proposal_emoji: str = "💡") -> None:
    @bot.event
