...
def main():
    ...
    parser.add_argument('--table', choices=['contributors', 'events', 'ongoing_votes', 'concluded_votes', 'all'],
                      help='Which table to query', required=True)
    parser.add_argument('--server-id', type=str,
                      help='Filter contributors by server ID')
    parser.add_argument('--guild-id', type=int,
                      help='Filter events by guild ID')
